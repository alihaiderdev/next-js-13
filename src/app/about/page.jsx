      ...
      <div className={styles.textContainer}>
        <div className={styles.item}>
          ...
          <p className={styles.desc}>
            ...
            <br />
            <br />
            voluptatum quo ea eveniet? Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus quae dolor, optio voluptatibus magnam iure
